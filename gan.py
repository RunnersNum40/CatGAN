...
class GAN:
    def __init__(self, image_shape, noise_shape):
        ...
        self.discriminator = get_disc_normal(self.image_shape)
        self.generator = get_gen_normal(self.noise_shape)
    ...
    def train(self, data_dir, num_steps=1000, batch_size=64, img_save_dir=None, log_dir=None):
        ...
        for step in range(num_steps): 
            ...
            if img_save_dir != None and (tot_step % 100) == 0:
                step_num = str(tot_step).zfill(4)
                save_img_batch(fake_data_X, f"{img_save_dir}{step_num:05d}_image.png")
...
if __name__ == "__main__":
    ...
    gan.train(data_dir, num_steps, batch_size, img_save_dir, log_dir)